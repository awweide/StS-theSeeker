...
public class Stoicism extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Stoicism.class.getSimpleName());
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,  new StoicismPower(p, magicNumber), magicNumber));
    }
