...
public class CleansingBrew extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(CleansingBrew.class.getSimpleName());
