...
public class Prescience extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Prescience.class.getSimpleName());
    // TODO: Image
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new PresciencePower(p, 1), 1));
    }
