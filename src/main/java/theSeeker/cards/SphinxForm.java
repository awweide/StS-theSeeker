...
public class SphinxForm extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(SphinxForm.class.getSimpleName());
    // TODO: Image
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new SphinxFormPower(p, magicNumber), magicNumber));
    }
