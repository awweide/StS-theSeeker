...
public class QuickAndEasy extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(QuickAndEasy.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new PlayRandomConditionalCardAction(m, "DRAW", CardType.ATTACK, 0));
    }
