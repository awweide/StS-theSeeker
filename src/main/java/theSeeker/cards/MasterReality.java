...
public class MasterReality extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(MasterReality.class.getSimpleName());
    // TODO: Image
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new MasterRealityPower(p), 1));
    }
