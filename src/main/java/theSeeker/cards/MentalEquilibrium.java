...
public class MentalEquilibrium extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(MentalEquilibrium.class.getSimpleName());
