...
public class LightExercise extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(LightExercise.class.getSimpleName());
