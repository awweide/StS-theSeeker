...
import theSeeker.powers.ClairvoyancePower;
import theSeeker.powers.PresciencePower;

import static theSeeker.DefaultMod.makeCardPath;

public class Clairvoyance extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Clairvoyance.class.getSimpleName());
    // TODO: Image
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new ClairvoyancePower(p, magicNumber), magicNumber));
    }
